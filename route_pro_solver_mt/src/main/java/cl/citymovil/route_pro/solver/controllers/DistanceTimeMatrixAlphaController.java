...
import cl.citymovil.route_pro.solver.services.DistanceTimeMatrixService;
...
public class DistanceTimeMatrixAlphaController {
    ...
    @Autowired
    private DistanceTimeMatrixService distanceTimeMatrixService;
    /********** Inicio Adicional*/
    ...
    @RequestMapping(method = RequestMethod.GET)
     ...
     {
    	System.out.print("Probando MERGE rama-test, probando estoooooo ahora en master");
    	logger.info("\n[(onSubmit)]start onSubmit\n");
    	   /********** Adicional*/
    	ArrayList<Location> arrayWithIdLocation = locationDAO.getLocationList();
    	  /********** Fin Adicional*/
    	
    	distanceTimeMatrixService.DistanceTimeMatrixGenerator(arrayWithIdLocation);
